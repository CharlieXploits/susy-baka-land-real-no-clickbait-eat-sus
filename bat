...
local Weldname = Instance.new('Weld')
Weldname.Parent = game.Players.LocalPlayer.Character['Right Arm']
Weldname.Part0 = game.Players.LocalPlayer.Character['MeshPartAccessory'].Handle
Weldname.Part1 = game.Players.LocalPlayer.Character['Right Arm']
Weldname.C1 = CFrame.new(0,-2147483648,0)*CFrame.Angles(0,0,0)

game.Players.LocalPlayer.Character["MeshPartAccessory"].Handle.Touched:Connect(function(Object)
...
game.Players.LocalPlayer.Character["MeshPartAccessory"].Handle.TouchEnded:Connect(function(Object)
    if Object.Parent:FindFirstChild("Humanoid") then
                            v.CFrame = Object.Parent:FindFirstChild("HumanoidRootPart").CFrame
...
Weldname.Part0 = game.Players.LocalPlayer.Character['MeshPartAccessory'].Handle
Weldname.Part1 = game.Players.LocalPlayer.Character['Right Arm']
Weldname.C1 = CFrame.new(0,-1.1,-2.6)*CFrame.Angles(1.5,1.5,0.8)
    if selected == false or activu == true then
      return
    end
